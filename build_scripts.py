...
os.system("jarsigner -verbose -sigalg SHA1withRSA -digestalg SHA1 -keystore keys/test.keystore platforms/android/app/build/outputs/apk/release/app-release-unsigned.apk alias_name")
